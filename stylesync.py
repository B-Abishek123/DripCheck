...
def main1_image_bodydetails(image_path):
    ...
    client = Groq(api_key="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")
...
def main1():
    ...
    if ch == '1':
        user_data = main1_capture_bodydetails()
    elif ch == '2':
        user_data = main1_image_bodydetails()

    occasion = input("Enter your occasion: ")
    print("Capturing current outfit data...")
    cap = cv2.VideoCapture(0)
    # Get frame dimensions for positioning text in top-right corner
    ret, frame = cap.read()
    frame_height, frame_width = frame.shape[:2]
    ...
    response = ai_model1(frame, user_data, occasion)
    pprint.pprint(response, indent=5, width=100)
    return response
...
def main2(age="18", race="Indian", gender="Male", weight="48", height="170", body_type="Little Slim", skin_tone="Little dark(Brown)", hair_color="Black", face_shape="Little round", facial_hair="Little, no beard", liked_colors="Light Blue, Black, White", hated_colors="Pink, Yellow, Green, Violet", other_preferences="None", occasion="Casual"):
    print("Inside main2")
    ...
    user_data = main2_manual_bodydetails(age, gender, weight, height, body_type, skin_tone, hair_color, face_shape, liked_colors, hated_colors, other_preferences, occasion)
    response = ai_model1(frame, user_data, occasion)
    pprint.pprint(response, indent=5, width=100)
    return response
...
print()
print("Welcome to Dress Finder!")
print()
print("1. Start Webcam and Capture Body, Skin and Facial Details\n2. Enter Body, Skin and Facial Details Manually")
...
if choice == '1':
    ...
    variables=["age", "race", "gender", "weight", "height", "body_type", "skin_tone", "hair_color", "face_shape", "facial_hair", "liked_colors", "hated_colors", "other_preferences", "occasion"]
    age = input("Enter your age: ") 
    race = input("Enter your race: ")
    gender = input("Enter your gender: ")
    weight = input("Enter your weight in kg: ")
    height = input("Enter your height in cms: ")
    body_type = input("Enter your body type (e.g., Slim, Athletic, etc.): ")
    skin_tone = input("Enter your skin tone (e.g., Fair, Medium, Dark): ")
    hair_color = input("Enter your hair color: ")
    face_shape = input("Enter your face shape (e.g., Round, Oval, Square, etc.): ")
    facial_hair = input("Enter your facial hair style (e.g., Clean-shaven, Beard, Mustache, etc.): ")
    liked_colors = input("Enter your liked colors (comma-separated): ")
    hated_colors = input("Enter your hated colors (comma-separated): ")
    other_preferences = input("Enter any other preferences you have: ")
    occasion = input("Enter your occasion (e.g., Formal, Casual, Wedding, etc.): ")
    print()

    main2(age, race, gender, weight, height, body_type, skin_tone, hair_color, face_shape, facial_hair, liked_colors, hated_colors, other_preferences, occasion)
